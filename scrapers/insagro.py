...
def main(base_url: str, page_notation: str, category: str):
    ...
    while True:
        ...
        lis: ResultSet[Tag] = soup.find_all("div", attrs={"class": "product-inner"})
        ...
        for li in lis:
            ...
            precio_tag = li.find("span", attrs={"class": "price"})
    ...
    file_path = os.path.join(current_path, "products_insagro.xlsx")
