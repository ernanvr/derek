...
def main(base_url: str, page_notation: str, category: str):
    ...
    while True:
        ...
        lis: ResultSet[Tag] = soup.find_all("li", attrs={"class": "product-col"})
        ...
        for li in lis:
            nombre_tag = li.find(
                "h3", attrs={"class": "woocommerce-loop-product__title"}
            )
            precio_tag = li.find("span", attrs={"class": "woocommerce-Price-amount"})
    ...
    file_path = os.path.join(current_path, "products_chilax.xlsx")
